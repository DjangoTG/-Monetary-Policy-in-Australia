...
plot(dates, y=Y[,1], ylab = "GDP [AUD Millions]", xlab = "Date", type = "l")
plot(dates, y=Y[,2], ylab = "Government Revenue [AUD Millions]", xlab = "Date", type = "l")
plot(dates, y=Y[,3], ylab = "Government Speding [AUD Millions]", xlab = "Date", type = "l")
plot(dates, y=Y[,4], ylab = "Government Debt [AUD Millions]", xlab = "Date", type = "l")
```
