...
gdp_temp <- xts::xts(gdp$value, gdp$date) 

spend <- readabs::read_abs(series_id = "A2304036K") 
spend_temp  <- xts::xts(spend$value, spend$date)

revenue <- readabs::read_abs(series_id = "A2302411R") 
revenue_temp <- xts::xts(revenue$value, revenue$date)

debt <- readabs::read_abs(series_id = "A3424499W") 
debt_temp <- xts::xts(debt$value, debt$date)
...
plot(dates, y=Y[,2], ylab = "Government Revenue /$Millions", xlab = "Date")
plot(dates, y=Y[,3], ylab = "Government Speding /$Millions", xlab = "Date")
plot(dates, y=Y[,4], ylab = "Government Debt /$Millions", xlab = "Date")
```
